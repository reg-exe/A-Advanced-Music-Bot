...
function printHeader() {
    ...
    console.log(`${colors.CYAN}│${colors.RESET}                     ${colors.BOLD}${colors.PURPLE}♪ A! MUSIC ♪${colors.RESET}                     ${colors.CYAN}│${colors.RESET}`);
...
function printSystemReady() {
    ...
    console.log(`   ${colors.DIM}${colors.WHITE}Developed with ${colors.PINK}♡${colors.WHITE} by A! Development${colors.RESET}`);
